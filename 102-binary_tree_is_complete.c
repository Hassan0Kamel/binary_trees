...
/**
 * binary_tree_is_leaf - ch
 * @node: pointer to the
 * Return: 1 if no NULL, return 0
 */
...
/**
 * binary_tree_height - measurry tree
 * @tree: pointer to the rooe height of
 * Return: the heigh, return 0
 */
...
/**
 * binary_tree_is_perfect - checke is perfect
 * @tree: pointee to check
...
/**
 * binary_tree_is_complete -  checkomplete
 * @tree: pointecheck
 * Return: 1 if s NULL, return 0
 */
